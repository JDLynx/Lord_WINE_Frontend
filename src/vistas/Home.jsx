...
import { XCircle } from 'lucide-react'; // Para icono de error
    ...
    useEffect(() => {
        const fetchProductos = async () => {
            try {
                ...
                setProductosHome(productosFiltrados);
            } catch (err) {
            ...
            <div className="page-container-home">
                ...
                <main className="bg-vistas-home">
                    {loading ? (
                        ...
                        <div className="flex flex-col items-center justify-center flex-grow p-10 min-h-[50vh]"> {/* min-h para asegurar espacio */}
                        ...
                        // Contenedor de productos normal
                        <div className="productos-container-home">
                            {productosHome.length === 0 ? (
                                <div className="text-center text-gray-600 p-8">
                                    <h2 className="text-2xl font-semibold mb-2">No hay productos disponibles en esta sección.</h2>
