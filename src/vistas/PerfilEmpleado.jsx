                                ...
                                <div className="lg:col-span-2">
                                    <div className="bg-white rounded-2xl shadow-lg p-10">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-6">
                                            ...
                                            {profileData.tiendaFisica && <InfoItem label="ID de Tienda Física" value={profileData.tiendaFisica.tiendIdTiendaFisica} icon={Store} />}
                                            {profileData.tiendaFisica && <InfoItem label="Nombre de la Tienda" value={profileData.tiendaFisica.tiendNombre} icon={Store} />}
                                        </div>
                                    </div>
                                </div>
                            </div>
