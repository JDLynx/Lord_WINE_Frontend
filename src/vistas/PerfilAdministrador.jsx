        ...
        <div className="flex flex-col min-h-screen overflow-x-hidden">
            ...
            >
                <div className="max-w-6xl mx-auto w-full">
                    <h1 className="text-3xl font-semibold text-black mb-8 text-center">Perfil Administrador</h1>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                                <div className="lg:col-span-1">
                                    <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center justify-center h-full">
                                        ...
                                        <p className="text-[#921913] font-semibold mb-4 text-xl">{profileData.role}</p>
                                    </div>
                                </div>

                                <div className="lg:col-span-2">
                                    <div className="bg-white rounded-2xl shadow-lg p-10 h-full">
                                        <h3 className="text-xl font-semibold text-black mb-8 border-b pb-4 border-gray-200">Información Personal</h3>
